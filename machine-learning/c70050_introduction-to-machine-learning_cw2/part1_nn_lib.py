...
class SigmoidLayer(Layer):
    ...
    def backward(self, grad_z):
        ...
        return np.multiply(grad_z, self.sigmoid(x) * (1 - self.sigmoid(x)))
...
class ReluLayer(Layer):
    ...
    def backward(self, grad_z):
        ...
        return np.multiply(grad_z, self.diffRelu(x))
...
class LinearLayer(Layer):
    ...
    def backward(self, grad_z):
        ...
        # This part is covered in slides 28-30 from Neural Networks - Part 2.
...
class Trainer(object):
    ...
    def shuffle(input_dataset, target_dataset):
        ...
        shuffled_indexes = np.random.permutation(np.shape(input_dataset)[0])
